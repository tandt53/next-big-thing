...
public class MultipartUtility {
     ...
     * @throws IOException if any problem occurs during processing file upload, the IOException will be thrown
     */
     ...
     * @param uploadFile uploadFile a File to be uploaded
     * @throws IOException if any problem occurs during processing file upload, the IOException will be thrown
     */
