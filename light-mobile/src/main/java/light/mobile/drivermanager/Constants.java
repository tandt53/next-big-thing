...
public class Constants {
    ...
    public static final String PREFIX_APPIUM = "light.appium.";

    // These properties are keys in config file
    // Common appium capability
    public static final String CAPABILITY_SERVER_URL = "light.appium.remote.url";
    ...
    public static final String CAPABILITY_PLATFORM_NAME = "light.appium.platformName";
    public static final String CAPABILITY_PLATFORM_VERSION = "light.appium.platformVersion";
    public static final String CAPABILITY_DEVICE_NAME = "light.appium.deviceName";
