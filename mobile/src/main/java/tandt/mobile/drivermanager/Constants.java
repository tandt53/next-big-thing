...
public class Constants {
    ...
    public static final String PREFIX_APPIUM = "nbt.appium.";

    // These properties are keys in config file
    // Common appium capability
    public static final String CAPABILITY_SERVER_URL = "nbt.appium.remote.url";
    ...
    public static final String CAPABILITY_PLATFORM_NAME = "nbt.appium.platformName";
    public static final String CAPABILITY_PLATFORM_VERSION = "nbt.appium.platformVersion";
    public static final String CAPABILITY_DEVICE_NAME = "nbt.appium.deviceName";
